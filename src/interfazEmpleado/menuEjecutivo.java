...
import panelesEmpleadoEjecutivo.principalCliente;
import panelesEmpleadoEjecutivo.principalContrato;
import panelesEmpleadoEjecutivo.principalPersona;
 ...
 * @author javam
 */
public class menuEjecutivo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(btnProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 220, 50));
        ...
        jPanel3.add(btnPro, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, 220, 50));
    ...
    private void btnProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductoActionPerformed
        formProductos frmProducto = new formProductos();
        frmProducto.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuEjecutivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new menuEjecutivo().setVisible(true);
            }
        });
    }
