...
public class Contrataciones {
    ...
    private String fecha_contrataciones;
    ...
    public String getFecha_contrataciones() {
        return fecha_contrataciones;
    }

    public void setFecha_contrataciones(String fecha_contrataciones) {
        this.fecha_contrataciones = fecha_contrataciones;
    }
