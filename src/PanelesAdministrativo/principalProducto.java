...
public class principalProducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnFormIngresar.setText("Ingresar Producto");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/gears.png"))); // NOI18N

        btnFormEliminar.setBackground(new java.awt.Color(255, 204, 102));
        btnFormEliminar.setText("Eliminar Producto");
    ...
    private void btnFormIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFormIngresarActionPerformed
        formProductos frmIngEmpleado = new formProductos();
        frmIngEmpleado.show();
